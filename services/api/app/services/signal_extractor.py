...
REAL_USAGE_PATTERNS = {
    "REAL_OWNED": {
        "keywords": ["내돈내산", "직접 구매", "제 돈으로", "영수증", "재구매"],
        "regex": [r"내\s*돈\s*내\s*산", r"제\s*돈으로\s*구매", r"직접.*구매"],
        "weight": 1.15,
    },
    "REAL_DURATION": {
        "keywords": ["1주 사용", "2주 사용", "3주 사용", "실사용", "사용기", "며칠 써봄"],
        "regex": [r"[0-9]+\s*(일|주|개월)\s*(사용|써봄|후기)", r"(한달|두달|보름)\s*(사용|써봄)"],
        "weight": 0.95,
    },
    "REAL_DRAWBACK": {
        "keywords": ["단점", "아쉬운 점", "불편", "별로", "불만", "재구매 의사 없음"],
        "regex": [r"단점\s*[:：]?", r"아쉬운\s*점", r"별로다?"],
        "weight": 1.0,
    },
    "REAL_VISIT": {
        "keywords": ["방문 후기", "직접 방문", "매장 방문", "방문함", "웨이팅", "주차"],
        "regex": [r"직접\s*방문", r"매장\s*방문", r"웨이팅\s*후기"],
        "weight": 0.95,
    },
    "REAL_CASUAL_TONE": {
        "keywords": ["솔직히", "진짜", "그냥", "써보니까", "먹어보니까", "가보니까"],
        "regex": [r"(써보니|먹어보니|가보니)까", r"솔직히"],
        "weight": 0.55,
    },
}
