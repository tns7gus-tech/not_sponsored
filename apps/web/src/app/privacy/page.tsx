...
export default function PrivacyPage() {
  return (
    <DocumentPageLayout
      ...
      description="Not Sponsored는 공개 검색 결과와 사용자가 직접 입력한 공개 URL만 분석 대상으로 삼습니다. 로그인 페이지, 이메일 주소, 비공개 커뮤니티는 분석하지 않습니다."
      updatedAt="2026-03-11"
    >
      <section>
        <h2 className="text-xl font-semibold text-white">1. 수집하는 정보</h2>
        <p className="mt-3">
          사용자가 입력한 검색어, 공개 URL, 최근 검색 기록과 브라우저 로컬 저장소 안의 세션 식별값이 저장될 수 있습니다. 검색 시작, 결과 조회, 원문 클릭 같은 기본 이벤트는 서비스 개선을 위해 기록됩니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-3">
          로그인 필요 페이지, 비공개 커뮤니티, 이메일 주소, 비표준 포트, 민감정보가 포함된 비공개 문서는 분석하지 않습니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-3">
          입력된 공개 데이터는 리포트 생성, 광고성 신호 분류, 오류 대응, 서비스 개선을 위해 사용합니다. 이 서비스는 자동 추정 결과를 제공하며 사실 확정이나 법적 판단 용도로 사용되지 않습니다.
        </p>
      </section>
