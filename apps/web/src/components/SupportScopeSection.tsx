  ...
  return (
    <section aria-labelledby="support-scope-title" className="mx-auto mt-14 w-full max-w-6xl">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-xs font-semibold tracking-[0.22em] text-slate-200">지원 범위</p>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        {SUPPORT_COLUMNS.map((column) => (
          <article key={column.title} className={`rounded-[24px] border p-5 ${column.className}`}>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-100">{column.description}</p>
      ...
      <p className="mt-4 text-xs leading-6 text-slate-200">
